...
public class StudentDBOperations {
    /** Student data kept with the database operations to preserve the requested package layout. */
    public record Student(String rollNumber, String name, String branch, int semester,
                          String contact, String email, String dateOfBirth) { }

    /** Subject-level marks and attendance data. */
